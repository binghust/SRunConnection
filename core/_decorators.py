...
checkchkstr = checkvars(
    varlist="chk_str",
    errorinfo="Lack of chk_str. Need to run '_generate_chksum' in advance"
)

checkencryptedchkstr = checkvars(
    varlist="encrypted_chk_str",
    errorinfo="Lack of encrypted_chk_str. Need to run '_encrypt_chksum' in advance"
)
